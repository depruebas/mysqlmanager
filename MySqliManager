...
class MySqliManager 
{
  ...
  public function Connect( $config = array()) 
  {
    ...
    if (!($this->_conn = mysqli_connect($this->HOST.":".$config['port'], $this->username, $this->password)))
    {
    ...
    {
      mysqli_set_charset( $this->encoding, $this->_conn);
      $this->Connected = "true";
    }
  ...
  {
    $return = mysqli_query($sql, $this->_conn);
    return ($return);
  }
